                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            ?>
                            <h1 class="page-header">New Drug Application Method </h1>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Create Drug Application Method
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <form role="form" action="<?php echo base_url() . 'DrugManagement/drugAppMethodSave' ?>" method="post">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label>Method Name</label>
                                                        <input type="text" class="form-control" id="DrugApplicationMethodName" name="DrugApplicationMethodName" value="" placeholder="Drug Application Method Name" required="True">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="1" id="DrugApplicationMethodIsActive" name="DrugApplicationMethodIsActive">Is Active
                                                        </label>
                                                    </div>
                                                </div>
