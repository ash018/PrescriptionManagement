                                ...
                                <div class="panel-body">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php
                                            $c = 1;
                                            foreach ($allCountry as $dCountry) {?>
                                                <tr class="odd gradeX">
                                                    <td class="center"><?php echo $c; ?></td>
                                                    <td class="center"><?php echo $dCountry['DrugFormName']; ?></td>
                                                    <td class="center"><?php if($dCountry['DrugFormIsActive'] == 1){echo 'Active';} else{echo 'Inactive';} ?></td>
                                                    <td class="center"><?php echo $dCountry['EntryDate']; ?></td>
                                                    <td class="center"><input type="button" class="btn btn-info editDCategoryData" data-toggle="modal" data-target="#myModal" data-node="<?php echo $dCountry['DrugFormId']; ?>" value="Edit"/></td>
                                                </tr>
                                                <?php
                                                $c++;
                                            }
